...
var vec__37571_37574 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_37575 = cljs.core.nth.call(null,vec__37571_37574,(0),null);
var only_after_37576 = cljs.core.nth.call(null,vec__37571_37574,(1),null);
var db_changed_QMARK__37577 = (!((only_before_37575 == null))) || (!((only_after_37576 == null)));
if(db_changed_QMARK__37577){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_37575);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_37576);
...
var map__37578 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__37578__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__37578__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__37580 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__37580__$1;
var event = cljs.core.get.call(null,map__37580__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29459__auto___37583 = arguments.length;
var i__29460__auto___37584 = (0);
while(true){
if((i__29460__auto___37584 < len__29459__auto___37583)){
args__29466__auto__.push((arguments[i__29460__auto___37584]));

var G__37585 = (i__29460__auto___37584 + (1));
i__29460__auto___37584 = G__37585;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq37582){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37582));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__28290__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__29466__auto__ = [];
var len__29459__auto___37591 = arguments.length;
var i__29460__auto___37592 = (0);
while(true){
if((i__29460__auto___37592 < len__29459__auto___37591)){
args__29466__auto__.push((arguments[i__29460__auto___37592]));

var G__37593 = (i__29460__auto___37592 + (1));
i__29460__auto___37592 = G__37593;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__37586_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__37587_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__37587_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__28278__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq37588){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__37589,G__37590,seq37588__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1505471934938
