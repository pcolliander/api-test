...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__37144 = cljs.core.instance_QMARK_;
var expr__37145 = reactive_val;
if(cljs.core.truth_(pred__37144.call(null,reagent.ratom.RAtom,expr__37145))){
return "ra";
} else {
if(cljs.core.truth_(pred__37144.call(null,reagent.ratom.RCursor,expr__37145))){
return "rc";
} else {
if(cljs.core.truth_(pred__37144.call(null,reagent.ratom.Reaction,expr__37145))){
return "rx";
} else {
if(cljs.core.truth_(pred__37144.call(null,reagent.ratom.Track,expr__37145))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1505471934184
