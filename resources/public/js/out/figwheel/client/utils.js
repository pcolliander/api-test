...
var or__28290__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34617 = {"detail":data};
return obj34617;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28278__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28278__auto__)){
var and__28278__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__34624 = cljs.core._EQ_;
var expr__34625 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34624.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34625))){
return ((function (pred__34624,expr__34625){
return (function (p1__34618_SHARP_){
return console.warn(p1__34618_SHARP_);
});
;})(pred__34624,expr__34625))
} else {
if(cljs.core.truth_(pred__34624.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34625))){
return ((function (pred__34624,expr__34625){
return (function (p1__34619_SHARP_){
return console.debug(p1__34619_SHARP_);
});
;})(pred__34624,expr__34625))
} else {
if(cljs.core.truth_(pred__34624.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34625))){
return ((function (pred__34624,expr__34625){
return (function (p1__34620_SHARP_){
return console.error(p1__34620_SHARP_);
});
;})(pred__34624,expr__34625))
} else {
return ((function (pred__34624,expr__34625){
return (function (p1__34621_SHARP_){
return console.log(p1__34621_SHARP_);
});
;})(pred__34624,expr__34625))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34628){
...
var eval_fn = cljs.core.get.call(null,map__34629__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34631_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34633,(0),null);
var v = cljs.core.nth.call(null,vec__34633,(1),null);
...
if(cljs.core.truth_((function (){var and__28278__auto__ = typeof localStorage !== 'undefined';
...
}catch (e34638){if((e34638 instanceof Error)){
var e = e34638;
return not_found;
} else {
throw e34638;
...
//# sourceMappingURL=utils.js.map?rel=1505471599241
