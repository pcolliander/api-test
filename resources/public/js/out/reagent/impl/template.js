...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28915__auto__,writer__28916__auto__,opt__28917__auto__){
return cljs.core._write.call(null,writer__28916__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__36996 = o;
(G__36996[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__28278__auto__ = !((jsprops == null));
if(and__28278__auto__){
var and__28278__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__37002 = jsprops;
(G__37002["defaultValue"] = value);

(G__37002["onChange"] = ((function (G__37002,v,value,on_change){
return (function (p1__37001_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__37001_SHARP_);
});})(G__37002,v,value,on_change))
);
...
var vec__37005 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__37005,(0),null);
var id = cljs.core.nth.call(null,vec__37005,(1),null);
var class$ = cljs.core.nth.call(null,vec__37005,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___37009 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___37009 == null)){
} else {
var key_37010 = temp__4661__auto___37009;
...
var G__37011 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__37011["name"] = c);
...
var len__29459__auto___37016 = arguments.length;
var i__29460__auto___37017 = (0);
while(true){
if((i__29460__auto___37017 < len__29459__auto___37016)){
args__29466__auto__.push((arguments[i__29460__auto___37017]));

var G__37018 = (i__29460__auto___37017 + (1));
i__29460__auto___37017 = G__37018;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37014){
var G__37015 = cljs.core.first.call(null,seq37014);
var seq37014__$1 = cljs.core.next.call(null,seq37014);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__37015,seq37014__$1);
});
...
break;
default:
var G__37021 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__37021;
continue;
...
var n__29235__auto___37023 = a.length;
var i_37024 = (0);
while(true){
if((i_37024 < n__29235__auto___37023)){
(a[i_37024] = reagent.impl.template.as_element.call(null,(a[i_37024])));

var G__37025 = (i_37024 + (1));
i_37024 = G__37025;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29235__auto___37026 = a.length;
var i_37027 = (0);
while(true){
if((i_37027 < n__29235__auto___37026)){
var val_37028 = (a[i_37027]);
if((cljs.core.vector_QMARK_.call(null,val_37028)) && ((reagent.impl.template.key_from_vec.call(null,val_37028) == null))){
(o["no-key"] = true);
} else {
}

(a[i_37027] = reagent.impl.template.as_element.call(null,val_37028));

var G__37029 = (i_37027 + (1));
i_37027 = G__37029;
continue;
} else {
}
...
var ctx = ({});
var vec__37030 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__37030,(0),null);
var derefed = cljs.core.nth.call(null,vec__37030,(1),null);
...
var G__37033 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37033) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__37033){
...
//# sourceMappingURL=template.js.map?rel=1505471933994
